...
<head>
  ...
  <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 32 32'%3E%3Crect width='32' height='32' rx='8' fill='%23133D72'/%3E%3Cdefs%3E%3ClinearGradient id='g' x1='0' y1='0' x2='1' y2='1'%3E%3Cstop offset='0%25' stop-color='%23FF6B35'/%3E%3Cstop offset='100%25' stop-color='%23F7C59F'/%3E%3C/linearGradient%3E%3C/defs%3E%3Ctext x='16' y='24' font-family='Georgia,serif' font-size='24' font-weight='700' fill='url(%23g)' text-anchor='middle'%3ER%3C/text%3E%3C/svg%3E">
</head>
<body>
  <nav class="nav" id="top">
    <a href="/uRead/" class="brand" aria-label="uRead 首页">
      <svg viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg" width="38" height="38">
        ...
        <rect width="40" height="40" rx="8" fill="#133D72"/>
        <text x="20" y="29" font-family="Georgia,serif" font-size="26" font-weight="700" fill="url(#lg)" text-anchor="middle">R</text>
      </svg>
    </a>
